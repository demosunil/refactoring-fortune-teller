Rails.application.routes.draw do  
  ...
  get("/lottery/:num",{ :controller => "lottery", :action => "lucky_unlucky" })
  ...
  #get("/zodiacs/:zodiacs_sign", { :controller => "zodiacs", :action => "zodiacs_action" })
  get("/zodiacs/:zodiacs_sign", { :controller => "fortunes", :action => "horoscopes" })
